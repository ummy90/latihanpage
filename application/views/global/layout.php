...
<body>
            ...
            <nav class="black">
                <div class="container">
                        ...
                        <div class="nav-wrapper">
                            <a href="<?php echo base_url();?>Buku" class="brand-logo"><img src="<?php echo base_url(); ?>assets2/img/1.png" width="75px" alt=""></a>
                            <ul class="right hide-on-med-and-down">
                                ...
                                <li><a class="btn Red" href="<?php echo base_url();?>/web/log">LOG-IN</a></li>
                            </ul>
                        </div>
                </div>
            </nav>
    ...
    <ul class="sidenav" id="mobile-nav">
        ...
        <li><a class="btn Red" href="portofolio.php">LOG-IN</a></li>
    </ul>
    <!-- SideNav-end -->
    <!-- Slider -->
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <img class=" responsive-img z-depth-5" width="250px" src="<?php echo base_url(); ?>assets2/img/1.png" alt="" srcset="">
        </div>
        <h3 class="header center white-text text-lighten-1 z-depth-5">PERPUSTAKAAN SMK MUHAMMADIYAH 1 YOGYAKARTA</h3>
       

      </div>
    </div>
    <div class="parallax"><img src="<?php echo base_url(); ?>assets2/img/sekolah.jpg" alt="Unsplashed background img 1"></div>
  </div>
  <!-- Slider end -->
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    Copyright 2020 
 &copy; : <a href="https://www.smarak.com/" target="_blank">| WEB DESIGN by Hagia XIIRPL</a>
                </div>
