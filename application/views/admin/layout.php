...
<div class="wrapper">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              foreach ($log as $key => $value) {
                ?>
              <img src="<?php echo base_url(); ?>gambar_petugas/jona.jpg" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs">HagiaGiovanna</span>
              <?php
              }
              ?>
            </a>
            <ul class="dropdown-menu">
              ...
              foreach ($log as $key => $value) {
                ?>
                <img src="<?php echo base_url(); ?>gambar_petugas/jona.jpg" class="img-circle" alt="User Image">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url(); ?>web/logout" class="btn Red btn-danger btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong><a href="http://smkmuh1-yog.sch.id/">SMK MUHAMMADIYAH 1 YOGYAKARTA</a></strong> 
  </footer>
