...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>petugas/Home" class="logo">
      ...
      <span class="logo-lg"><b>PERPUS</b>MUHI</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              foreach ($log as $key => $value) {
                ?>
              <img src="<?php echo base_url(); ?>gambar_petugas/messi.jpg" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs">Hagia Pratama</span>
              <?php
              }
              ?>
            </a>
            <ul class="dropdown-menu">
              ...
              foreach ($log as $key => $value) {
                ?>
                <img src="<?php echo base_url(); ?>gambar_petugas/messi.jpg" class="img-circle" alt="User Image">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url(); ?>web/logout" class="btn orange btn-danger btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <center>
        <a href="<?php echo base_url();?>petugas/Home">
          <img src="<?php echo base_url(); ?>assets2/img/1.png" alt="" srcset="" width="75px">
        </a>
      </center>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2019 <a href="www.smarak.net">SMK MUH 1 YOGYAKARTA</a>.</strong> All rights reserved.
  </footer>
